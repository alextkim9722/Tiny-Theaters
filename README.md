...
* [ ] Review the requirements (1.0 hours)

* [ ] Download the provided data (0.1 hours)

* [ ] Review the provided data (1.0 hours)

* [ ] Identify any research that I need to do (1.0 hours)

---

_These steps can be done in class on Friday_

* [ ] Design initial database schema (2.5 hours)
...
* [ ] Write the DDL in a file named `rcttc-schema.sql` to create the database (4.0 hours)
  * [ ] Drop and create the database
  * [ ] Create all of the tables

* [ ] Import the provided data (0.5 hours)
...
## Organized Data
* Customer First, Customer Last, Customer P/N, Customer Email, Customer Address
* Seat
* Show, Ticket Price, Date
* Theater, Theater Address, Theater P/N, Theater Email
